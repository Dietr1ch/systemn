  ...
  systemd = {
    ...
    settings = {
      Manager = {
        ...
        # system. If left null, systemd will use its default of 10 minutes; see
        # systemd-system.conf(5).
        RebootWatchdogSec = "5m";

        # The amount of time which can elapse when kexec is being executed
        # before a watchdog hardware device will automatically reboot the
        # system. This option should only be enabled if reloadTime is also
        # enabled; see kexec(8).
        KExecWatchdogSec = "5m";
      };
    };
